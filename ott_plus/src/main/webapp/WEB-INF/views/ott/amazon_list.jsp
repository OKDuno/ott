    ...
    <div class="content"> 
      ...
      <div class="scrollable">
        <table>
          ...
          <tbody>
          	<c:forEach var="amlist" items="${amlist}" varStatus="status">
          	<tr>
				<td>${amlist.ranking}</td>
				<td>${amlist.title}</td>
				<td>${amlist.score}</td>
				<td width="150" height="210"><img src="/filepath/${amlist.img}.jpg" style="max-width: 100%; height: auto;"/> </td>
				
				<td>${atlist[status.index].ranking}</td>
				<td>${atlist[status.index].title}</td>
				<td>${atlist[status.index].score}</td>
				<td width="150" height="210"><img src="/filepath/${atlist[status.index].img}.jpg" style="max-width: 100%; height: auto;"/> </td>
			</tr>
			</c:forEach>
          </tbody>
        </table>
