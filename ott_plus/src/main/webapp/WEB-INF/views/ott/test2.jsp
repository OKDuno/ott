      ...
      <div class="scrollable">
        ...
        <form action="test2" method="post">
        	<table>
		        ...
		        <tbody>
		        	<tr>
		        		<td><input type="text" name="title" value="<c:out value="${testlist[0].title}"/>"></td>
						<td><input type="text" name="genre" value="<c:out value="${testlist[0].genre}"/>"></td>
						<td><input type="text" name="actor" value="<c:out value="${testlist[0].actor}"/>"></td>
