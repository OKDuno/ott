...
<form action="/review/insert" method="post">
          <div class="one_third first">
            ...
            <input size="22" required placeholder="제목을 입력하세요." name="rev_title">
          </div>
          <div class="one_third">
            <label for="email">태그 <span>*</span></label>
	            넥플릭스<input type="radio" class="form-control" name="rev_teg" value="넥플릭스">
          ...
          <div class="block clear">
            ...
            placeholder="내용을 입력해주세요." name="rev_content"></textarea>
          </div>
          <div>
